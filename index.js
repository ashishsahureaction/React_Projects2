//javascript adds behaviour to the web page(web pages intreactive and dynamic),html-hypper text markup lanaguge(basic structure),
//css-cascading style sheets(displayed style).
...
//Function scope-we can not accsse even var outside
// function fun(){
//     var a= 100;
//     let b=10;
//     const c=1;
...
// console.log(c);
//............
//Block scope we can accsse var as global outside   
// { var a= 100;
//     let b=10;
//     const c=1;}
...
//Input HTTP and out in JSON from rest api architecture(rest=representational state transfer)
...
//ITERATOR..NEXT()..GENERATO
//In JavaScript, a generator function is a special type of function that uses the yield keyword to produce a sequence of values 
//and that can be paused and resumed during execution.When a generator function is called, it returns a generator object, which can be used to iterate through the 
//sequence of values produced by the function.It allows you to iterate through a sequence of values, one at a time, by calling the generator's next() method. 
//The generator function uses the yield keyword to indicate where it should pause and return the next value in the sequence. 

//An iterator is an object that implements the next() method, which returns an object with two properties: value, which is the next value in the sequence, and done, 
//which is a boolean indicating whether or not the iterator has reached the end of the sequence. In JavaScript, any object that implements the Symbol.iterator method 
//is considered an iterator. In summary, A generator is a special type of function in JavaScript that uses the yield keyword to produce a 
//sequence of values and an iterator is an object that implements the next() method and it's used to iterate over the elements of a collection.
//In JavaScript, a generator function is a special type of function that uses the yield keyword to produce a sequence of values. When a generator function is called, 
//it returns a generator object, which can be used to iterate through the sequence of values produced by the function. The next() method on a generator object is 
//used to advance the generator to the next value in the sequence. When called, the generator resumes execution from where it last paused, 
//using the yield keyword. The value of the yield expression is returned as the value of the next() method.
//in total calling a genrator function doesnot execute it at at once instead it return an genrator object when we call the next method on the iterator object, 
//function is excuted untill it sees the next yield keywords. The next method return an object with ''value'' property which has the value that has been returned 
//by yield and a "done" property which stands for whether a function has complted execution or not.

//ITERATOR-is an object which defines two things one-a sequence, and 2-a return value on its termination.
// having a next() method that returns an object with two properties: next value and done(sequence).
...
//DATA TYPES IN JS
//Seven DATA TYPES PRIMITIVES 1-undefined(var x,),2-Boolean means ture or false ,3-Number(var x=4,),4-String(var x="ram"),
//5-Bigint,6-Symbol,7=null(var x=null)
//Four Refrence type 1-Object (var x={value:prporety}),2-Array(var x=["list1","list2"]),3-Maps, 4-Set
//.............................................................................................

//Symbol-help to creat unique values
//It was important to maintain unique object keys to prevent the overwriting of values having similar object key 
//as this could result in loss of data.
...
// user[age]=25;
// console.log(user);
// console.log(user.name);//object value
...
//     gender:"Male",
// }
// // for(value in user){console.log(value);}//for of method not for object
...
//Map is a collection of key-value pairs. To create a new Map, you can use the Map constructor:
//map required syntax of new with Map with space in between(new Map)3 barckets     ([[ 'value' ,'property' ]]) or ([[ 'Key' ,'value' ]]).

// let obj= {name:"anil",age:30}
// console.log(obj);
...
//............................................................................................................
//SET....................................................................................
//SET data type-is a collection of unique values. Each value can only occur once in a Set,not dulpicate value. 
//A Set can hold any value of any data type.
//set required syntax of new with Set with space in between(new Set)2 barckets.
...
//In JavaScript, a Set is a collection of unique values. To create a new Set, you can use the Set constructor:
...
//diffrence between null(absence of value) vs undefined(absence of defnition) ? bug 2-date type of null is object.
//NULL used to indicate that a variable has no value intentionally.
// let myVariable = null;
...
//In JavaScript, variables can be declared but not initialized, like this:
//let myVariable;
//At this point, the variable "myVariable" exists, but it has no value assigned to it. 
//Attempting to use or access the variable before it has been initialized will result in a reference error, and the variable will be undefined.
...
// Increment x++ postfix or ++x prefix and decrenment --x or x-- operetor

// Increment and Decrement operator-pre and post
//operator: x++ or ++x or --x or x--

// let y,x=5;
// y=++x//prefix add one before
// console.log(y)
// console.log(x)

// let y,x=5;
// y=x++//postfix add one after
...
//3-Comparisson or relational operator to check ture or false(!= means not equal too) return boolean value
// var a = 20;
// var b = 50;
// console.log(a == b);
// console.log(a != b);
...
//The ‘==’ (euality)operator checks whether the two given operands are equal or not. If so, it returns true. Otherwise it returns false.
...
//consider only first positive vlaue if not than the last value will be the result.

// const reslut=null||{}||""||false; 
// console.log(reslut);//{}

// const reslut=null||false||"";
// console.log(reslut);//blanck////empty string "" is not +ve value it was in last i.e
...
//3-Logical NOT operator(!) know as logical complement,negation) change true to false and vice versa,reverse the value,
//(elsclamation mark showing does not eual to !=).
//(it is unary operator, a unary operator is an operator that operates on a single operand or argument.Ex-Arithmetic,typeof,delete,void opertor.)
//( The void operator is typically used to obtain the undefined,that evaluates an expression and returns undefined )
// console.log(!(false));
...
// console.log(9 ** 3); //9*9*9 exponetial opretor
// console.log(100 ** -1)
// console.log(5 + "Ashish")
// console.log(5 - "Ashish")//Nan

//Diffrence between == (equality)vs ===?(strict equality)
// var num1 = 5;
// var num2 = '5';
// console.log(num1 == num2)//true checked only value due to coersion
// console.log(5=='5');
...
//1-IF..ELSE(if,if-else,if-else-if) 2-SWITCH STATEMENT..3-WHILE LOOP,4-DO-WHILE LOOP,5-FOR IN LOOP,6- FOR OF LOOP,7-CANDITIONAL OE TERNARY 0PERTOR
...
//2-Switch statement(this and that)
...
//........  ..................................................
//types of loop-1-while, 2-do-while, 3-for, 4-forEach(), 5-map(), 6-for…in, 7-for…of
//3-WHILE LOOP STATEMENT VS DOWHILE LOOP- DO WHILE LOOP GIVE ATLESAT OUTPUT and check condition in last

//3-WHILE LOOP STATEMENT-through a block of code as long as a specified condition is true,check the condition first and then print and having semicolon in the last.
// var num = 1;
// while (num <= 10) {
//     console.log(num);
//     num++;
...
//4-DO WHILE LOOP
//is a variant of while loop,will execute code block once, before checking if the condition is true, 
//then it will repeat the loop as long as the condition is true, it will print first and then check the condition
// var num = 1;
// do {
//     console.log(num);
//     num++
...
//String interpolation is a technique used to embed expressions or variables inside a string.
// let a = 5;
// let b = 10;
// console.log(`Fifteen is ${a + b} and not ${2 * a + b}.`);
// console.log("Fifteen is ${1 + 5} and not ${2 * a + b}.");
...
// const we=`name, age ,pet`;
// // const you=`hi ${name} ${age-10} ${pet}`;
// // const you=`${name} ${name} ${age-10} ${pet}`;
// console.log(you);
// console.log(we);
// console.log(typeof(we))//now changed to string
...
//Regular Expressions or "regex" or "regexp"-is a sequence of characters that forms a search pattern to describe what you are searching for.
...
// console.log(a.search(/has/i));//position of has at 12 
...
// console.log(text.match(/is/g));//ig uses all is belongs to sentance(one is in this).
// console.log(text.match(/is/ig));
//......................................................................................................................
...
//Syntax errors - are also known as parsing errors.occur at the interpretation time (before run, and only effected will not work)
...
//refrence error -engine try to find out a specific value before initialization and not get./sytex-dulicate value /type error--not initilise 
//and declare in the same line.
...
//TDZ-time between when a variable is declared and when it is initialized. During this time, the variable is in a "dead zone" and cannot be accessed or used.
//let-cant be redeclare shows syntex error.
...
//     console.log("end of error")
// }catch{console.log("Error has occured")}
// finally{console.log("run anyways")};//error has occured

// try{
//     console.log("start of try");//start of the try
//     var a="bllabala";
//     console.log("end of error")//end of error
// }catch{console.log("Error has occured")};

//..............................................................
//try-test,catch=handle,throw=statement,finally=execute result.
//try-statement define a code block to run.
//catch-statement define a code block to handdle any error.
//finally-statement define a code block to run regardless of the result.
//throw-define satement a custom error. 

// The code within the finally block is executed after the try and catch blocks, regardless of whether an exception was thrown or not.
//The finally block contains code that is guaranteed to be executed after the try and catch blocks, regardless of whether an exception was thrown or not. 
// try {
...
// function show(){ var x=20; try{alert("value of x:"+x);}catch(err){alert("something is wrong");}}
// show()
...
//SetTimeout-its a web api,call back function 
//SetTimeout- execute only once and setTimeout() method calls a function after a number of milliseconds. 1 second = 1000 milliseconds 
//and executed only once then after use setInterval(repeat) and then after use clearTimeout to stop settimeout and clearinterval for setInterval to stop.
...
//ClearTiemout-to stop the setTimeout-have to assigne store value(var/let/const) and clearInterval for setinterval and then assigne that store value to ClearTimeout n.

// let stop= setInterval(() => {console.log("maybe");},1000);
// clearInterval(stop);

//Stop Timer after 5 count-
// let timer=setInterval(fn,1000);
// let counter=0;
// function fn(){if (counter==5) {clearInterval(timer);}
// else{console.log("Hello"); counter++;}}

//loop will not work with setInterval..
// let stop = setInterval(() => {for (let i=0; i<5; i++)
//      {console.log('hello world', i);};1000});
//     setInterval(console.log(stop),1000);
...
//BOXESS-three kind of popup boxes:1-Alert box,(display msz to user and 1 ok button) 
//2-Confirm box,(display 2 button which condition ok and cancle) and 
//3-Prompt box (need to take input details from user).

//1-Alert Box-When an alert box pops up, th e user will have to click "OK" to proceed.
// window.alert("hello");
// alert("hi");
...
//display 2 button which condition ok and cancle.
...
//Cookies are saved in key-value pairs like: username = John Doe
...
//2-Square or Box bracket-[]-used to describe array and define index of something.
//3-Curly or Braces bracket-{} -used to define block or statement,loops,if,object,destructuring

//Function-is a block of code designed to perform a particular task and is executed when "something" invokes it.(call it).
//FUNCTIONS IN JS-to re-use code and sepration of concern
...
//A function Expression is similar to a function declaration without the function name.if we store function in variable its function expression.
...
//Temporal dead zone is the time between from hositing to get initilize or get some value (will get refrence error)
//TDZ-time between when a variable is declared and when it is initialized. During this time, the variable is in a "dead zone" and cannot be accessed or used.
//when a variable is declared means Let x and it is initialized means putting some value like =10 
//Variables declared with let or const are hoisted to the top of the scope, but their assignments are not. 
//This means that the variable is in memory, but it's not accessible until it's been assigned.
//The let and const variables are not accessible before they are initialized with some value,
//let and const are hoisted  (but hoisting not applied on let and const )but refrence error 
//bcz memory allocated initially in script not in global(not from global/window scope-check in source) to them as undefined initially 
//but after they defined as refrence error
...
//var=function scope,hosted as undefined, while LET AND CONST=Block scope and not reassigned and redceclare(let), 
//means always constant and refrence error if accessing before declartion.
...
// var a=10,//store one value
// var a=10,20,30;//error
// var a="10,20,30";// its string store value as a whole.
// var a=[10,20,30]; //in array individual values stored.
...
// console.log(arr.sort().reverse());//desending order

// const number = ['2', '5', '500', '8', '100'];
// console.log(number.sort());//first value only
...
// console.log(myfriends[-1]);//undefind
...
//adding condition to break the loop,will exit the loop.
// var myfriends = ['kapil', 'amit', 'sudhansu', 'ritu']
// for (check of myfriends) {if (check=='sudhansu') break; console.log(check); }

////adding condition to continue loop will leave that element and execute rest (continue vs break )
// var myfriends = ['kapil', 'amit', 'sudhansu', 'ritu']
// for (check of myfriends) {if (check=='sudhansu') continue; console.log(check); }
...
//The only difference between them is the entities they iterate over: for..in iterates over all keys of an object. 
//for..of iterates over the values arrays and string,not over the object.
//for in loop work with object while for of will not.
...
//or
// var myfriends = ['kapil', 'amit', 'sudhansu', 'ritu'];
// myfriends.forEach((element,index) => { console.log(index,element); });

//myfriends.forEach((element,index,array) => { console.log(index,element,array[1]); });

// var myfriends = ['kapil', 'amit', 'sudhansu', 'ritu'];
// myfriends.forEach((index) => { console.log(index); });//show only element
...
//1-forEach, 2-includes,3-Filter,4-Map,5-Reduced,6-Some,7-every,8-sort,9-array.from(),10-array.of(),
//11-find,12-fill,13-copywithin,14-flat(),15-flat.map..etc
...
// console.log(myfriends.indexOf('kapil'));
// console.log(myfriends.indexOf('ram'));//-1 will return
// console.log(myfriends.indexOf('kapil', 1));//

// //last Index off( search from backword)
// var myfriends = ['kapil', 'sudhansu', 'ritu'];
// console.log(myfriends.lastIndexOf("kapil"));
// console.log(myfriends.lastIndexOf("ram"));
...
//find method-give only one element in return
...
// console.log(prise.findIndex((value) => value < 10));//-1
//...............................................................
...
// const y = prise.filter(any=>any<400);//(element..function..element..condition)
// console.log(y);

// const y = prise.filter(any=>any<100);//(element..function..element..condition)
// console.log(y);//return empty array
...
//or
// const animals = ["pigu", "dog", "lion", "tiger"];
// console.log(animals.push("chicken"));//give length
...
// const a=[1,2,3,]
// console.log(a.fill(1,2,3,).map(n=>n+"*"));
...
//Reduce array method-applies a function against an accumulautor and each element in the array (from left to right) 
...
// const arr = [5, 1, 3, 2, 6];
// const sum1=arr.reduce((acc,value)=>value+acc,2);//if need to add 2 in total.
// console.log(sum1);
...
// const max = arr.reduce((total, key) => total+key,0);
...
// console.log(arr.sort());//asending 
// // console.log(arr2.sort((a,b)=>a>b?-1:1));//desending order

// const arr=[2,6,9,7,3,1];
// console.log(arr.sort((a,b)=>a>b?1:-1));//asending order
// console.log(arr.sort((a,b)=>a>b?-1:1));//desendind order
...
// console.log(ages.sort().reverse());//check error at 5
...
//Array.from method()-this change all thing that are array-like or iteralble into true array 
//especially working with DOM so that we can use other array methods.
...
//Array.of method()..
// Array.of method this create array from every arguments (function) passed into it. convert arguments into array
// const name2= "ashish"
...
//3-Property access [] same as chartAt
...
// let a=yourName.split(" ");//where find the space break from there only like 1 is javascript then 2nd is is,
...
//var student ={name:"mohan",age:"28",hobies:["cricket","hockey"]}
...
//Spread operator helps in destructring the vales(spread-kholne/todne ka kaam..Rest-jodne ka kaam)
...
// console.log(Object.fromEntries(arrayobject));////convert object into array
...
//*********************************Asyncronous JS**************************************
//JavaScript is the single-threaded synchronyse programming language. This means that the JavaScript engine has only one call stack. 
//Therefore, it only can do one thing at a time.
//When executing a script, the JavaScript engine executes code from top to bottom, line by line. In other words, it is synchronous.

//Asynchronous means you can move to another task before the previous one finishes.
//For example, the JavaScript engine can:
//-Request for a data from a remote server, Display a spinner
//-When the data is available, display it on the webpage.

//-Hoisting - "we can access variable and function before initilize it or put some value in it."

//Scope chain-chain of all lexical environment

//Global Scope-pertaing to the window object
...
// function two() {console.log("step 2");}

// function one() {setTimeout(() => {console.log(one);}, 2000);
//     console.log('step 1');}
// one();
// two();
...
//vocabulary...................
//function evoke, invoke, global execution context, execution context, call stack, push, allocation, temporal dead zone, memory component
// (variable environment),code component(thread of execution),key function, synchronise, global scope, global space, scope chain, lexical environment,
//tagging, memory, block, scope, function, syntactic, syntactic sugar, encounter this line, identifier (var n=2, n is identifier),prototypal inheritance, 
//dot-notation, transition, event propagation interactive functionality, level zero environment,


//..........................................................................................

// Important Points:
//A “higher-order function” is a function that accepts functions as argument and/or returns a function.

//...................
//JavaScript functions are first-class citizens.
//We can store functions in variables, pass them to other functions as arguments, and return them from other functions as values.
//uses as arguments in the other function. termed as First Class function or first class citizen.

//Call back function-A callback is a function passed as an argument to another function.
//it give access to whole asynchronus world to the synchronus single threaded language,due to call back function we can do Async things in JS.
//One function has the resposibilty of other function to make them execute. Ex-SetTimeout , Event Listner etc..

//disadvantages of callback function-1-Callback hell, 2-Limited functionalty, 3-difficult to raed and debbug.4-inversion of control

// setTimeout(function(){console.log("timmer");},1000)//function and 5000 is like a argument of settimeout function and timer
// function x(y){console.log("x");y();}
// x(function y (){console.log("y")})

///Event listener......................

//Event listener is a process in JS that 'waits for an event to occur'. It listens to the event and responds accordingly to the event fires.
//the simple example of an event is a user clicking the mouse or pressing a key on the keyboard.
//Event listener allow us to add interactive functionality to HTML elements by “listening” to different events that take place on the page, 
//such as when the user clicks a button, presses a key, or when an element loads.

//What is event listener in HTML? The addEventListener() method allows to add event listeners on any HTML DOM object such as HTML elements, 
...
//There are two ways of event propagation in the HTML DOM, bubbling and capturing(trickling).
...
//Callbacks are functions passed as arguments into other functions to make sure mandatory variables are available within the 
//callback-function's scope,comes in callback queue. 
...
//major diffrence is hoisting.Function expression are not hoisted.
...
//AJAX combination of: A browser built-in XMLHttpRequest object (to request data from a web server) JavaScript 
//and HTML DOM (to display or use the data)

//.................................................
//why we start array with index 0-Martin Richards, creator of the BCPL language (a precursor of C ), designed arrays initiating at 0 as 
//the natural position to start accessing the array contents in the language, 
...
//Memoization- is an optimization technique that makes applications more efficient and faster. stored solution of solved problem
...
//instead of computing it again.use already stored solutions.
...
//JS WORK IN EXCUTION CONTEXT AND EXCUTION CONTEXT HAVE 2 cpmponents,1-Memory Compnent,2-Code component
...
//can only execute one comamnd at a time in specific order & it can only go to the next line once the current line has been finished executing.
...
//Therefore, it only can do one thing at a time.
//JavaScript engine uses a call stack to manage execution contexts and call stack is to manage the order of execution of execution context.
...
//block is also know as "Compound statement"-combining multiple js statement into a group.and we can use this group statemnt as single entity next time.
//2-Function Scope[Function abc(){statement var carname="bmw";}each function create a new scope]
//3-Global [variable decalre outside a function become global]

//refrence error-engine try to find outspecific value before initilization and not get/sytex-dulicate value /
//type error--not initilise and declare in the same line.
...
//Why:They can handle multiple asynchronous operations easily and provide better error handling than callbacks and events bcz JS is 
//single threaed language if jumped to the next line while doing anync work will not get correct output.
//A JavaScript Promise object can be or Having 3 stages-1-Pending (having resultvalue undefined),2-Fullfilled (having resultvalue value),
//3-Reject((having result value error).
//promise() 1-reslove() then()
//promise()2-reject() catch
//Promise.then() takes two arguments, a callback for success and another for failure.
//fisrt have to take a varibale and define as new promise  
//let prom =new Promise();
//than assigne a function into this promise //let prom =new Promise(function(){});
...
//console.log(prom);// dont put semicolon while calling promes bcz its an object
...
//Sandbox-A sandbox is an isolated testing environment that enables users to run programs or open files without affecting the application, 
//system or platform on which they run. Software developers use sandboxes to test new programming code. 
...
//purpose of both the function is same to get print the first n last name then we can call this function with the help of "call()"..
//edit if any(call or === function.call())
...
// //3-Bind=just like call only but saying dont invoke function directly as we did in call and apply just make a copy of that function 
//and use whene ever you want.
...
//if dont want to get reflect change in other object than..make the copies of objects with diffrent methods like..1-shallow copy or shalow clone,
//2--Deep Copy or deep clone
//1-shallow copy or shalow clone- copy only main object or first level of object-2 way
//1-Object.assign and 2-spread operator (destrutring es6)
//1-Object.assign-first make new object then assign new object with blanck object and main object.  
...
//Deep clone or deep copy-if having object inside an object and so on,only one way (json.parse then json.stringify()); 
//and not taking function and date for deep cloning in new object.
...
//deep vs shallow copy- A deep copying means that value of the new variable is disconnected from the original variable while a 
...
// const obj2={roll:25,proto :obj};//now we can access obj in obj2.
// console.log(obj2);

// let student ={name:"anil",lastName:"Sharma",
// getFullName:function(){return this.name+" "+this.lastName}}
// console.log(student.getFullName());

// let teacher ={name:"satya",lastName:"prakash",
// getFullName:function(){return this.name+" "+this.lastName}}
// console.log(teacher.getFullName());

//make an object and check in web tool after console showing prototype and this prototype object having some properties like constructor,
//hasOwnProperty,isPrototypeOf,etc
...
// function Person(first,last,a){this.firstName=first;this.lastName=last;this.age=a; 
// this.fullName=function(){console.log(this.firstName+this.lastName);};}
//Person p should be in capital letter and below P ... 3 dots saying its contructor function
...
//lets we do also have a class of all working people lets make the class of working people, where vishwajeet is also there 
//bcz he is software enge.
...
//we made a group of object and give a class name ex-vishwjeet(man)-vishwjeet is a object of man class. and man has common property 
//like name:xxx,height,weight etc
...
//classes are devide into property((veriables like let a,let b which need to declare inside the class only) and methods
//(like functions and uses only property declare inside this class).
...
//     message(){console.log("Hello Everyone");}//method, to call this method we have to make object for this method
//(make variable then assigne object)
...
//Sometimes people say that class is a “syntactic sugar” (syntax that is designed to make things easier to read, but doesn’t 
//introduce anything new), because we could actually declare the same thing without using the class keyword at all:


//Inheritance-Class.........................
//Inheritance allow a class(sub-class) to acquire the propoerties and behaviour of another class(super-class).

//inheritance is, an object getting access to the propoerties and methods of other object.

//It help to reuse,customiize and enhance the existing code so it help to write a code accuretly and reduce the devlopment time.
//help not to repeat the code.
...
//Unlike functions, and other JavaScript declarations, class declarations are not hoisted.  That means that you must declare a class before
// you can use it:with the use of extends keyword we can inherit classes property and with keyword super method inherit function from parent.
...
//https://www.interviewbit.com/react-interview-questions/#what-are-keys
